...
//            slide.corectie();
//
//            if(surub.cleste.getPosition()>0.5){
//                time.startTime();
//            }
//
//            if(slide.slide.getCurrentPosition()<200 && time.milliseconds()>300){
...
////            }
//
//            surub.apucare(gamepad1.right_bumper, gamepad1.left_bumper);x
...
//                surub.turn.setPosition(0.5);
//            }
//            surub.turn.setPosition(0.35);
//
//            if(slide.slide.getCurrentPosition()>-380){
//                surub.rasucire.setPosition(0.5);
//            }
//
